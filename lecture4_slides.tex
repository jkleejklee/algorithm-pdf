...
\begin{frame}{解最短路问题}
    \begin{columns}
        ...
        \begin{tikzpicture}[global scale=0.65]
            ...
            \draw (1) --(2) node[very near start,sloped,above]{2};
            \draw (1) --(3) node[very near start,sloped,above]{5};
            \draw (1) --(4) node[very near start,sloped,above]{1};
            \draw (2) --(5) node[very near start,sloped,above]{12};
            \draw (2) --(6) node[very near start,sloped,above]{14};
            \draw (2) --(7) node[very near start,sloped,above]{10};
            \draw (3) --(5) node[very near start,sloped,above]{6};
            \draw (3) --(6) node[very near start,sloped,above]{10};
            \draw (3) --(7) node[very near start,sloped,above]{4};
            \draw (4) --(5) node[very near start,sloped,above]{13};
            \draw (4) --(6) node[very near start,sloped,above]{12};
            \draw (4) --(7) node[very near start,sloped,above]{11};
            \draw (5) --(8) node[very near start,sloped,above]{3};
            \draw (5) --(9) node[very near start,sloped,above]{9};
            \draw (6) --(8) node[very near start,sloped,above]{6};
            \draw (6) --(9) node[very near start,sloped,above]{5};
            \draw (7) --(8) node[very near start,sloped,above]{8};
            \draw (7) --(9) node[very near start,sloped,above]{10};
            \draw (8) --(10) node[very near start,sloped,above]{5};
            \draw (9) --(10) node[very near start,sloped,above]{2};
...
\begin{frame}
    \begin{tikzpicture}[every label/.style={blue}]
        ...
        \node[CC2] (10)[label=above:$f_5(E){=}0$] at(10,0){$E$};
        \draw (1) --(2) node[very near start,sloped,above]{2};
        \draw[red,very thick] (1) --(3) node[very near start,sloped,above]{5};
        \draw (1) --(4) node[very near start,sloped,above]{1};
        \draw (2) --(5) node[very near start,sloped,above]{12};
        \draw (2) --(6) node[very near start,sloped,above]{14};
        \draw (2) --(7) node[very near start,sloped,above]{10};
        \draw (3) --(5)[red,very thick] node[very near start,sloped,above]{6};
        \draw (3) --(6) node[very near start,sloped,above]{10};
        \draw (3) --(7) node[very near start,sloped,above]{4};
        \draw (4) --(5) node[very near start,sloped,above]{13};
        \draw (4) --(6) node[very near start,sloped,above]{12};
        \draw (4) --(7) node[very near start,sloped,above]{11};
        \draw[red,very thick] (5) --(8) node[very near start,sloped,above]{3};
        \draw (5) --(9) node[very near start,sloped,above]{9};
        \draw (6) --(8) node[very near start,sloped,above]{6};
        \draw (6) --(9) node[very near start,sloped,above]{5};
        \draw (7) --(8) node[very near start,sloped,above]{8};
        \draw (7) --(9) node[very near start,sloped,above]{10};
        \draw[red,very thick] (8) --(10) node[very near start,sloped,above]{5};
        \draw (9) --(10) node[very near start,sloped,above]{2};
        \end{tikzpicture}
