...
\begin{frame}{计算过程}
    \begin{tikzpicture}
        ...
        \draw [very thick,blue](1) --(2) node[near start,sloped,above]{4};
        \draw (1) --(3) node[near start,sloped,above]{9};
        \draw (1) --(4) node[near start,sloped,above]{21};
        \draw (2) --(3) node[very near start,sloped,above]{8};
        \draw (2) --(4) node[near start,sloped,above]{17};
        \draw (3) --(4) node[near start,sloped,above]{16};
        \draw [very thick,blue](5) --(6) node[near start,sloped,above]{4};
        \draw (5) --(7) node[near start,sloped,above]{9};
        \draw (5) --(8) node[near start,sloped,above]{21};
        \draw [very thick,blue](6) --(7) node[very near start,sloped,above]{8};
        \draw (6) --(8) node[near start,sloped,above]{17};
        \draw (7) --(8) node[near start,sloped,above]{16};
        \draw [very thick,blue](9) --(10) node[near start,sloped,above]{4};
        \draw (9) --(11) node[near start,sloped,above]{9};
        \draw (9) --(12) node[near start,sloped,above]{21};
        \draw [very thick,blue](10) --(11) node[very near start,sloped,above]{8};
        \draw (10) --(12) node[near start,sloped,above]{17};
        \draw [very thick,blue](11) --(12) node[near start,sloped,above]{16};
