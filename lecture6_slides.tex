...
\begin{frame}{2352 -- Stars (poj.org)}
    ...
    \begin{center}
        \begin{tikzpicture}[every node/.style={star,fill=background,draw},global scale=.6]
...
\begin{frame}{树堆}
    \begin{itemize}
        ...
        \begin{center}
            \begin{tikzpicture}[every node/.style={circle split,fill=background,draw},global scale=.6]
